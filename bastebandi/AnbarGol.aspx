<%@ Page Title="" Language="C#" MasterPageFile="~/bastebandi/MasterPage.master" AutoEventWireup="true" CodeFile="AnbarGol.aspx.cs" Inherits="bastebandi_AnbarGol" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="text-center">
        <div style="padding: 10px;">
            <img src="../Decor/Images/loading.png" style="width: 30px; margin-right: 10px; display: none;" />
