...
public partial class main : System.Web.UI.Page
{
    ...
    protected void btnlogin_OnClick(object sender, EventArgs e)
    {
        ...
        //{
            cnn.Open();
            SqlCommand cmd = new SqlCommand("select user_level.name as level,users.leveluser as user_id,users.id as idmaster from users,user_level where users.user_name='" + txtname.Text + "' and users.codemd5='" + encryptString(txtpass.Text) + "' and user_level.user_id=users.leveluser", cnn);
            ...
            if (dr.Read())
            {
                ...
                if (dr["level"].ToString() == "rikhtegari")
                    ...
                    Response.Redirect("depogol/gol_user.aspx");
                ...
                else if (dr["level"].ToString() == "porcelain_storage")
                    Response.Redirect("storage_map/Map_storage.aspx");
                    ...
                    Response.Redirect("storage_map/Decor_stor.aspx");
