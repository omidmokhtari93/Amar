<%@ Page Title="مشاهده تناژ روزانه" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="daily_result_tonazh.aspx.cs" Inherits="_Default" %>
...
<center style=" vertical-align:middle;" > 
        <asp:Panel ID="pnlsearch" runat="server" BorderStyle="Solid" Width="90%" 
            Height="72px">
            <table dir="ltr" style="width: 70%; table-layout: fixed; border-collapse: separate;" 
                id="tbldate1" border="0" frame="border">
                <tr>
                    <td class="style2">
                    ...
                    <td class="style1">
                        <asp:Label ID="Label5" runat="server" Font-Names="tahoma" Font-Size="Small" 
                            Text="         "></asp:Label>
                        <td class="style2">
                            <asp:Label ID="lblyearstart" runat="server" Font-Names="tahoma" 
                                Font-Size="Small" Text="سال"></asp:Label>
                        </td>
                        <td class="style3">
                            <asp:Label ID="lblmounthstart" runat="server" Font-Names="Tahoma" 
                                Font-Size="Small" Text="ماه"></asp:Label>
                        </td>
                        <td class="style1">
                            <asp:Label ID="lbldaystart" runat="server" Font-Names="tahoma" 
                                Font-Size="Small" Text="روز"></asp:Label>
                        </td>
                        <td class="style1">
                        ...
                        <tr>
                            <td class="style2">
                                <asp:DropDownList ID="dryear" runat="server" Font-Names="Tahoma" 
                                    Font-Size="Small" style="margin-left: 0px" TabIndex="3" Width="60px">
                            ...
                            <td class="style3">
                                <asp:DropDownList ID="drmounth" runat="server" Font-Names="Tahoma" 
                                    Font-Size="Small" style="margin-left: 0px" TabIndex="1" Width="60px">
    ...
    <br />
        <asp:GridView ID="grid_wagon" runat="server" AutoGenerateColumns="False" 
            ...
            <Columns>
                <asp:BoundField DataField="tonazh" HeaderText="تناژ روز" ReadOnly="True" 
                ...
                <asp:BoundField DataField="tarikh" HeaderText="تاریخ" 
...
<br />
     ...
     <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
        ConnectionString="<%$ ConnectionStrings:taghdis_amar %>" SelectCommand="SELECT    max(tarikh)as tarikh,SUM(waight)  as tonazh
...
">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
        ...
        SelectCommand="SELECT    max(tarikh)as tarikh,SUM(waight) as tonazh
