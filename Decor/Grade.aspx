<%@ Page Title="آمار درجه بندی" Language="C#" MasterPageFile="~/Decor/MasterPage.master" AutoEventWireup="true" CodeFile="Grade.aspx.cs" Inherits="Decor_Grade" %>
...
<div class="tab-content">
    <div class="panel panel-primary" style="position: relative;">
        <div class="panel-heading" style="text-align: center">آمارواحد درجه بندی</div>

        <div class="row" style="text-align: right;">
            <div class="col-sm-2">
                <label style="display: block;">&nbsp</label>
                <button type="button" class="button" onclick="createTables();" id="btnShow">نمایش</button>
            </div>
            <div class="col-sm-8">
      
                <div class="col-sm-3">
                    <label style="display: block;">آمار</label>
                    <asp:DropDownList runat="server" ID="drGlaze" CssClass="form-control text-right" ClientIDMode="Static"  Width="100%" TabIndex="3" >
                        <asp:ListItem Value="1">لعاب یک</asp:ListItem>
                        <asp:ListItem Value="2">لعاب دو</asp:ListItem>
                        <asp:ListItem Value="3">مجموع دو لعاب</asp:ListItem>
                    </asp:DropDownList>
                </div>
                <div class="col-sm-3">
        ...
        <div class="panel-footer"  >
            <div class="row" style="padding: 0; margin:auto;width: 60%">
...
<script>
    ...
    function createTables() {
        if ($('#txtEndDate').val() != '' && $('#txtStrtDate').val() != '') {
            ...
            $('#gridod2').empty();
            AjaxData({
                url: 'ProgramDecor.asmx/GetGrade',
            ...
            function createGTables(e) {
                ...
                var tbl1Body = [];
                var tbl2Body = [];
                tbl1Body.push('<tr><th>ردیف</th><th>نام آیتم</th><th>A</th><th>1/5</th><th>C</th></tr>');
                tbl2Body.push('<tr><th>ردیف</th><th>نام آیتم</th><th>A</th><th>1/5</th><th>C</th></tr>');
