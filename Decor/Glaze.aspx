<%@ Page Title="آمار لعاب" Language="C#" MasterPageFile="~/Decor/MasterPage.master" AutoEventWireup="true" CodeFile="Glaze.aspx.cs" Inherits="Decor_Glaze" %>
...
<div class="panel panel-primary" style="position: relative;">
    <div class="panel-heading" style="text-align: center">آمارواحد لعاب</div>
...
<script>
    ...
    function createTables() {
        if ($('#txtEndDate').val() != '' && $('#txtStrtDate').val() != '') {
            ...
            $('#gridod2').empty();
            AjaxData({
                url: 'ProgramDecor.asmx/GetGlaze',
            ...
            function createGTables(e) {
                ...
                var tbl1Body = [];
                var tbl2Body = [];
                tbl1Body.push('<tr><th>ردیف</th><th>نام آیتم</th><th>تعداد</th></tr>');
                tbl2Body.push('<tr><th>ردیف</th><th>نام آیتم</th><th>تعداد</th></tr>');
